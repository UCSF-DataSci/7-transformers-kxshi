...
def test_chat(questions, model_name="HuggingFaceH4/zephyr-7b-beta", api_key=API_TOKEN):
    """
...
def save_results(results, output_file="C:/Users/kevxs/OneDrive/Documents/DATASCI 223/7-transformers-kxshi/results/part_2/example.txt"):
    """
